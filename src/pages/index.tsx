...
export default function Page() {
  ...
  return (
    <div>
        ...
        <div
          ...
          <div className='absolute inset-x-0 bottom-0'>
            <PanelHeader
              ...
              <div>
                <p className='mb-3'>
                  You&apos;re looking at a 3D visualization of the Enigma
                  machine rotors, the heart of the machine.
                </p>
                <p className='mb-3'>
                  Within each rotor is a wiring structure that acts as a
                  substitution cipher, connecting and transforming each letter
                  of the alphabet to a different letter. When a key is pressed,
                  an electrical signal is sent through the set of rotors,
                  transforming into a different letter as it passes through the
                  complex internal wiring structure within each rotor.
                </p>
                <p className='mb-3'>
                  Each keypress also turns the rotors, and thus changes the
                  entire structure of the substitution.
                </p>
                <p className='mb-3'>
        ...
        <div className='flex flex-col md:w-[372px] md:gap-8 xl:w-[520px]'>
            ...
            <PanelHeader
              ...
              <div>
                <p className='mb-3'>
                  ...
                  and inspect the signal transformation through the plugboard
                  and rotors.
                </p>
                <p className='mb-3'>
                  During actual use, messages were typed into the machine one
                  letter at a time. Pressing a letter would activate a light
                  next to the corresponding enciphered letter on a component
                  called the &ldquo;lampboard&rdquo;.
                </p>
                <p className='mb-3'>
                  From there, the ciphertext would be translated to Morse code
                  and sent via radio to a recipient.
                </p>
                <p className='mb-3'>
                  The encryption process is bi-drectional &mdash; meaning that
                  if two machines have the same rotor starting positions and
                ...
                <p className=''>
                  You can test this by copying your ciphertext and pasting it
          ...
          `}>
            ...
            <PanelHeader
              ...
              <div>
                <p className='mb-3'>
                  The plugboard is an additional layer of configuration which
                  adds complexity to the cipher. There are 150 trillion possible
                ...
                <p className='mb-3'>
                  ...
                  <span className='text-yellow-500'>input</span> into the
                  rotors, and once after the signal is reflected and{' '}
      ...
      <div className='hidden h-[2rem] items-center justify-end gap-2 px-8 text-[0.6rem] text-slate-700 md:flex'>
        <div>
          Made by{' '}
          <a
            className='text-slate-600'
            href='https://alextebbs.com/portfolio/enigma/?theme=minimal'>
            Alex Tebbs
          </a>
        </div>
        <div>&mdash;</div>
        <div>
          ...
          <a
            className='text-slate-600'
            href='https://github.com/alextebbs/enigma'>
            Github
          </a>
        </div>
      </div>
