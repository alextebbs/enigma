import { Letters, Letter, WireTableClass } from './components/machine/Machine'

export const KEYBOARD_LAYOUT = ['QWERTZUIO', 'ASDFGHJK', 'PYXCVBNML']

export const ALPHA = 'ABCDEFGHIJKLMNOPQRSTUVWXYZ'.split('') as Letters
...
export const availableRotors = [
  {
    ...
    visualOffset: 0,
    visualPosition: 0,
    wireTable: new WireTableClass(),
    inverseWireTable: new WireTableClass(),
  },
  {
    name: 'II',
